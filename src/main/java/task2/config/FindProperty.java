...
public class FindProperty {
    ...
    private static final String PROPERTIES_PATH = "task2.properties";
    private static final String CUSTOM_PROPERTIES_PATH = "task2_custom.properties";
    ...
    public static String getParentDirectoryFromJar() {
        String dirtyPath = DataSourceConfig.class.getResource("").toString();
